...
from routers import dataset_router, schema_importer # Import the new schema_importer
...
app.include_router(schema_importer.router) # Include the new schema importer router
