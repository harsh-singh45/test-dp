...
const DatasetsContent = () => {
    ...
    const handleSchemaImported = () => {
        setShowSchemaModal(false);
        fetchDatasets(); // Refresh the list after import
    };
    ...
    const handleUpdateComplete = () => {
        ...
        fetchDatasets(); // Refresh the list to show updated data
    };
        ...
        <div>
            ...
            <div className="d-flex align-items-center justify-content-between mb-3">
                <div className="d-flex gap-2 ms-auto">
                    ...
                    <button className="btn btn-outline-secondary btn-sm" onClick={() => setShowSchemaModal(true)}><i className="bi bi-file-earmark-arrow-down me-1"></i>Import Schema</button>
            ...
            <SchemaImportModal 
                ...
                onComplete={handleSchemaImported}
            />
